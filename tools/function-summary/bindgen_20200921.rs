...
pub struct ncplane_options {
    ...
    pub horiz: ncplane_options__bindgen_ty_1,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union ncplane_options__bindgen_ty_1 {
    pub x: cty::c_int,
    pub align: ncalign_e,
    _bindgen_union_align: u32,
}
#[test]
fn bindgen_test_layout_ncplane_options__bindgen_ty_1() {
    assert_eq!(
        ::core::mem::size_of::<ncplane_options__bindgen_ty_1>(),
        4usize,
        concat!("Size of: ", stringify!(ncplane_options__bindgen_ty_1))
    );
    assert_eq!(
        ::core::mem::align_of::<ncplane_options__bindgen_ty_1>(),
        4usize,
        concat!("Alignment of ", stringify!(ncplane_options__bindgen_ty_1))
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<ncplane_options__bindgen_ty_1>())).x as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ncplane_options__bindgen_ty_1),
            "::",
            stringify!(x)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<ncplane_options__bindgen_ty_1>())).align as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_ncplane_options() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ncplane_options>())).horiz as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(ncplane_options),
...
extern "C" {
    ...
    pub fn ncplane_set_fg_rgb(n: *mut ncplane, channel: cty::c_uint) -> cty::c_int;
}
extern "C" {
    pub fn ncplane_set_bg_rgb(n: *mut ncplane, channel: cty::c_uint) -> cty::c_int;
}
extern "C" {
...
extern "C" {
    #[doc = " Redraw the ncreel in its entirety. The reel will be cleared, and tablets"]
    #[doc = " will be lain out, using the focused tablet as a fulcrum. Tablet drawing"]
    #[doc = " callbacks will be invoked for each visible tablet."]
...
extern "C" {
    ...
    #[doc = " styling to text in the standard output paradigm. No flags are yet defined;"]
    #[doc = " 'flags' should be set to 0."]
...
extern "C" {
    pub fn ncdirect_getc_nonblocking(n: *mut ncdirect) -> cty::c_int;
}
extern "C" {
    #[doc = " See ppoll(2) for more detail. Provide a NULL 'ts' to block at length, a 'ts'"]
    #[doc = " of 0 for non-blocking operation, and otherwise a timespec to bound blocking."]
