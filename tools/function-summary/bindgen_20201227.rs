...
pub struct nccell {
    ...
    #[doc = " 1B → 6B (8 bits of EGC width, bias-1)"]
    pub width: u8,
...
extern "C" {
    #[doc = " Set the ncplane's base nccell to this nccell. It will be used for purposes"]
    #[doc = " of rendering anywhere that the ncplane's gcluster is 0. Erasing the ncplane"]
...
extern "C" {
    #[doc = " Set the ncplane's base nccell to this cell. It will be used for purposes of"]
...
extern "C" {
    ...
    #[doc = " To actually write (and free) this, invoke ncdirect_raster_frame()."]
...
extern "C" {
    #[doc = " Takes the result of ncdirect_render_frame() and writes it to the output. The"]
    #[doc = " 'align', 'blitter', and 'scale' arguments must be the same as those passed"]
    #[doc = " to ncdirect_render_frame()."]
