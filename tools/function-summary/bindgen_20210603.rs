...
pub const ncscale_e_NCSCALE_INFLATE: ncscale_e = 5;
...
#[doc = " aspect ratio. NCSCALE_INFLATE does the same, but without interpolation."]
#[doc = " NCSCALE_STRETCH stretches and scales the image in an attempt to fill the"]
#[doc = " entirety of the plane. NCSCALE_NONE_HIRES and NCSCALE_SCALE_HIRES behave"]
#[doc = " like their counterparts, but admit blitters which don't preserve aspect"]
#[doc = " ratio."]
...
extern "C" {
    #[doc = " return the number of columns occupied by 'c'. returns -1 if passed a"]
    #[doc = " sprixcell. see ncstrwidth() for an equivalent for multiple EGCs."]
...
extern "C" {
    ...
    #[doc = " a multiple of 3 for this RGB data."]
...
extern "C" {
    ...
    #[doc = " newline-delimited, and subject to change."]
...
extern "C" {
    ...
    #[doc = " to get its geometry via ncdirect_geom_frame(), or to use the same file with"]
